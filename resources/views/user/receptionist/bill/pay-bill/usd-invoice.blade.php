            ...
            <div style="float: right; width: 50%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%; text-align: right;">{{ $bill_detail['usd_price'] }}</td>
                        <td style="width: 30%; text-align: right;">{{ $bill_detail['usd_total'] }}</td>
                    </tr>
                    @endforeach
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right;">{{ $usdPrice }} USD</td>
                    </tr>
                </table>
            </div>
        </div>
