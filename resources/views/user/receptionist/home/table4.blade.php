<div class="dropdown">
    <li class="btn-group dropdown-toggle">
        <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <img src="{{ asset('img/table-short.jpg') }}" class="rounded border border-primary"> 
        ...
        <div class="dropdown-menu">
            ...
            @elseif($table4->status == 'run')
            <div class="dropdown-divider"></div>
            <a class="dropdown-item text-primary font-weight-bold" href="edit-bill-{{ $table4->table_id }}">
